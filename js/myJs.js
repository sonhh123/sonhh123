...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho anh lí do em thích anh đi :3',
        html: true,
        width: 900,
        padding: '3em',
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Tối nay em học xong thì mình call chơi game nha !!!đồng ý thì nhắn tin cho anh ",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/hoang.hong.son.716/';
                  }
            })
        }
    })
